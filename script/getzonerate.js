      ...
      //   alert(dhllocalrate);
       ...
       //  var upsexpeditedlocalrate = getupsexpeditedlocalrate(zoneupsexpedited,chargeweight);     
        // var upsexpeditedusdrate = decimaltofiveorten(upsexpeditedlocalrate * currencyratehktousd);
         ...
         var fedexieelocalrate = new Number(getfedexieelocalrate(zonefedexiee,chargeweight)) ;  
        ...
        var fedexipelocalrate = new Number(getfedexipelocalrate(zonefredexipe,chargeweight)) ;  
...
//香港FEDEXIEE的价格
function getfedexieelocalrate(zonefedexiee,chargeweight){
...
//香港FEDEXIPE的价格
function getfedexipelocalrate(zonefedexipe,chargeweight){
